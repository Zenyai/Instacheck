...
<center><img src="img/ajax-loader.gif"><br /><br /> We are gathering your UNFOLLOWERS! This may take a while. <br/><br/></center>
...
$(function() {
    $("#dvloader").show();
    $(".block1").load("loaddata.php", function(){ $("#dvloader").hide(); });
    return false;
});
</script>
